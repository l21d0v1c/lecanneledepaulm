    ...
    <header className="sticky top-0 z-40 w-full border-b border-black bg-transparent">
      <div className="container flex h-44 items-center justify-between py-4">
        <Link to="/">
          <Button
            variant="default"
            className="text-base font-bold text-white bg-black px-10 py-8 rounded-full hover:bg-gray-800 transition-colors" // Ajustement du padding pour une ellipse plus "pleine"
          >
