...
const products: Product[] = [
  ...
  },
  {
    id: "13",
    name: "Pâtisseries",
    description: "1x Banoffee ou Entremets chocolats ou Tarte Mojito ou Tarte Citron",
    price: 3.50,
    imageUrl: "/placeholder.svg",
    category: "creation"
  },
  {
    id: "14",
    name: "Pâtisseries",
    description: "6x Banoffee ou Entremets chocolats ou Tarte Mojito ou Tarte Citron",
    price: 16.00,
    imageUrl: "/placeholder.svg",
    category: "creation"
  },
  {
    id: "15",
    name: "Pâtisseries",
    description: "8x Banoffee ou Entremets chocolats ou Tarte Mojito ou Tarte Citron",
    price: 21.00,
    imageUrl: "/placeholder.svg",
    category: "creation"
  },
