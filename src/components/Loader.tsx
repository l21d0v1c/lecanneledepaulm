...
const Loader: React.FC = () => {
  return (
    <div className="loader-overlay fixed inset-0 bg-loader-dark-bg z-[9999]">
      ...
      <div className="loader absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100px] h-[100px] animate-animate">
        <div className="photo flex absolute inset-0 items-center justify-center">
          <img src="/logo2.png" alt="Logo" className="loader-logo h-32 w-32 rounded-full box-shadow-cannelé-sm animate-rotate m-1" />
          <img src="/logo2.png" alt="Logo" className="loader-logo h-32 w-32 rounded-full box-shadow-cannelé-sm animate-rotate m-1" />
          <img src="/logo2.png" alt="Logo" className="loader-logo h-32 w-32 rounded-full box-shadow-cannelé-sm animate-rotate m-1" />
        </div>
      </div>
